                ...
                $("#getbook").click(function(){
                    ...
                    $.get(loadbookURL, function(jsonData){
                        ...
                        $.each(jsonData, function(index, item){
                            item = jsonData;
                            var tr = $("<tr></tr>");
                            tr.append("<td>" + item[index].titleId + "</td>");
                            tr.append("<td>" + item[index].title + "</td>");
                            tr.append("<td>" + item[index].type + "</td>");
                            tr.append("<td>" + item[index].price + "</td>");
                            tr.append("<td>" + item[index].sales + "</td>");
                            tr.append("<td>" + item[index].pubdate + "</td>");
                            $("tbody").append(tr);
